...
CREATE TABLE `bookings` (
  ...
  `direct_flight_chart_ids` longblob,
  `return_flight_chart_ids` longblob,
  PRIMARY KEY (`id`),
  UNIQUE KEY `pnr` (`pnr`),
...
-- Dump completed on 2024-02-02 21:18:03
